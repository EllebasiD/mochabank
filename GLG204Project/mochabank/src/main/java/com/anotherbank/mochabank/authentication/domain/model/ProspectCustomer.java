...
import com.anotherbank.mochabank.domain.model.Address;
import com.anotherbank.mochabank.exception.CheckException;

/**
 * This class represents a prospect customer for the Mocha Bank company.
 * 
 * @author Isabelle Deligniere
 */
@SuppressWarnings("serial")
@Entity
@Table(name = "T_PROSPECTCUSTOMER") 
public final class ProspectCustomer extends User implements Serializable {
	// ======================================
    // =             Attributes             =
    // ======================================
	@Id
    ...
    public ProspectCustomer(final String username) {
    	setUsername(username);
    }

    public ProspectCustomer(final String username, final String firstname, final String lastname) {
    	setUsername(username);
    ...
    public void checkData() throws CheckException {
    	if (firstname == null || "".equals(firstname))
            throw new CheckException("Invalid prospect customer first name");
        if (lastname == null || "".equals(lastname))
            throw new CheckException("Invalid prospect customer last name");
    }
    /**
	...
	/**
	 * This method gets the address of a prospect customer.
	 * @return address	the address of a prospect customer.
	 */
	...
	/**
	 * This method sets the role of a prospect customer.
	 * @param role	the role of an a prospect customer.
	 */
	public void setRole(final Role role) {
		this.role = role;
	}
	/**
	 * This method gets the role of a prospect customer.
	 * @return role	the role of a prospect customer.
	 */
	public Role getRole() {
		return role;
	}
