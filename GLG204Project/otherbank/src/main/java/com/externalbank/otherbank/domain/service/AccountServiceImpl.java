...
import com.externalbank.otherbank.authentication.domain.dao.CustomerRepository;
...
import com.externalbank.otherbank.domain.service.HTTPSender;
...
public class AccountServiceImpl implements AccountService {
     ...
     * @param accountIdB	The identifier of the account receiving the deposit. 
     * @param amount	The amount to be deposited into the account.
     * @param minute	The minute to schedule the transfer.
